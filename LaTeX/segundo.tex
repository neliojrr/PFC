...
O Portugol aqui definido é baseado em \cite{Farrer1999}. O Livro utilizado para
...
Nas seções subsequentes é possível ver como o portugol foi proposto para este compilador.
