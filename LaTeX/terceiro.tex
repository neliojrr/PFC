...
disponível de maneira online, apenas através de um navegador. A questão a ser discutida sempre é sobre a proposta
...
o compilador uma parte de um todo. Vejamos agora nas seções abaixo alguns trabalhos relacionados.
...
Este é o mais alternativo de todos acima apresentado. Sua intenção é a de ensinar o \textit{Ruby on Rails} através
